...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        Toast.makeText(this, "onCreate function call",
            Toast.LENGTH_SHORT).show()

        Snackbar.make(mycl,"onCreate function " +
                "call",Snackbar.LENGTH_LONG).show()
    }
    override fun onStart() {
        super.onStart()
        Log.i(TAG, "onStart function call")
        Toast.makeText(this, "onStart function call",
            Toast.LENGTH_SHORT).show()
    ...
    override fun onStop() {
        ...
        Toast.makeText(this, "onStop function call",
            Toast.LENGTH_SHORT).show()
    ...
    override fun onPause() {
        ...
        Toast.makeText(this, "onPause function call",
            Toast.LENGTH_SHORT).show()
    ...
    override fun onRestart() {
        ...
        Toast.makeText(this, "onRestart function call",
            Toast.LENGTH_SHORT).show()
    ...
    override fun onResume() {
        ...
        Toast.makeText(this, "onResume function call",
            Toast.LENGTH_SHORT).show()
    ...
    override fun onDestroy() {
        ...
        Toast.makeText(this, "onDestroy function call",
            Toast.LENGTH_SHORT).show()
